...
function [bestmem,nfeval] = diffevolution_function(NP,D,F,CR,itermax,strategy)
% Run DE minimization
%
% Output arguments:
% ----------------
...
%     yTrans, scale, theta);
[distorted, sample, xdata, ydata] = imretrieve(distorted, pop(ibest,3),...
    pop(ibest,4), pop(ibest,1), pop(ibest,2));
val(1)=mi(original, distorted, 'Normalized');
%--------------------------------------------------------------------------
...
% [distorted, sample, xdata, ydata] = imretrieve(distorted, xTrans,...
%     yTrans, scale, theta);
[distorted, sample, xdata, ydata] = imretrieve(distorted, pop(i,3),...
    pop(i,4), pop(i,1), pop(i,2));
val(i)=mi(original, distorted, 'Normalized');
%--------------------------------------------------------------------------
...
% [distorted, sample, xdata, ydata] = imretrieve(distorted, xTrans,...
%     yTrans, scale, theta);
[distorted, sample, xdata, ydata] = imretrieve(distorted, pop(ui,3),...
    pop(ui,4), pop(ui,1), pop(ui,2));
tempval=mi(original, distorted, 'Normalized');
%--------------------------------------------------------------------------
